...
interface CursorMasteryClientProps {
  courseId: string;
  priceInCents: number;
...
function CursorMasteryBuyButton({
  courseId,
  className,
  children,
}: {
...
export function CursorMasteryClient({
  courseId,
  priceInCents,
  hasPurchased,
  isLoggedIn,
      ...
      <section className="py-32 px-6 border-t border-border">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <CursorMasteryBuyButton
              courseId={courseId}
              className="group inline-flex items-center justify-center gap-3 px-12 py-4 bg-foreground text-background text-sm font-medium tracking-wide hover:bg-foreground/90 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
